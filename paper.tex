...
\begin{figure}
%\begin{tikzpicture}
%	\node at (0,0) [circle,fill=black!50]{};
%\end{tikzpicture}
	\includegraphics{stableswarm}
\end{figure}
...
%%D(b) = bD_{pos}(b) 
%%\end{equation}
%%\fbox{\textit{do we mean product of $b$ and $D_{pos}$?}}
...
\mathcal{N}_b}}\magn{bb'}}{\mathlarger{\sum_{b \in
...
\mathcal{S}}}~\mathlarger{\sum_{b' \in \mathcal{N}_b}}\Big(\magn{bb'} -
...
\mu_p(\mathcal{S}) = \frac{\mathlarger{\sum_{b \in \mathcal{S}} P(b)}}{\mathlarger{\sum_{b \in \mathcal{S}}}|\mathcal{N}_b| + \mathlarger{\sum_{b \in \mathcal{S}}}|rep(b)|}
\end{equation}
\fbox{\textit{what is $rep(b)$ here ?}}
...
\sigma_p(\mathcal{S}) = \sqrt{\frac{\mathlarger{\sum_{b \in \mathcal{S}}}\Big(P(b)-\mu_p(\mathcal{S})\Big)^2}{\mathlarger{\sum_{b \in \mathcal{S}}}|\mathcal{N}_b| + \mathlarger{\sum_{b \in \mathcal{S}}}|rep(b)|}}
\end{equation}
