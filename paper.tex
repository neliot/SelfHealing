...
\begin{abstract}
%\boldmath
Swarms consist of many agents that interact using a simple set of rules that create emergent behaviours. One such behaviour makes a swarm tolerant of failures. Failures occur for may reasons; for example: resource exhaustion, component failure, or a disruption from an external event. The loss of agents reduces the size of a swarm and changes the structure in places where the agents are lost. A swarm's structure can also be irregular from an initial deployment or due to an obstacle in its path. These changes in the structure and/or size do not stop a swarm from functioning but can affect the outcome of a task to which the swarm is being applied. The paper introduces and demonstrates an emergent behaviour that can be induced into a swarm that can counter the effect of agent loss or irregular structures within a swarm. The behaviour causes concave deformities to be removed creating a healing-effect. This technique is implemented by each agent identifying it's position in relation to it's neighbours. If the agent meets a specific criteria the agent's `normal' movement is altered in such a way as to remove a gap between two of it's neighbours. These changes in direction of agents that meet the criterion cause the swarm, as a whole, to be reorganised into a more uniform structure with no internal voids.
\end{abstract}
...
The full visibility check~(Fig.~\ref{algo:CheckVisibility}) takes each pair in turn and using the cosine rule~\eqref{eq:CosineRule1} checks for a `visibility gap'. 
...
{Convex agents\label{reduced:Perimeter2}}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=5cm]{figures/VoidConcave1}
{Agent concave motion\label{concave:VoidConcave1}}
...
{Concave reduction result\label{fig:InnerPerimeter3}}
...
{Outer Perimeter (swarm without voids)\label{fig:OuterPerimeter2}}
...
{Concave reduction result (swarm without voids)\label{fig:OuterPerimeter3}}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/BaselineConcaveEffectDist}
{Baseline/Concave effect using distance metric\label{concave:BaselineConcaveEffectDist}}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/BaselineConcaveEffectMag}
{Baseline/Concave effect using cohesion/repulsion\label{concave:BaselineConcaveEffectMag}}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/BaselineConcavePerimeter}
...
%COVERBASELINE1.py
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/BaselineConcaveEffectPath1}
{Baseline/Concave path effect (Full)\label{concave:BaselineConcaveEffectPath1}}
...
%COVERBASELINE1.py
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/BaselineConcaveEffectPath2}
{Baseline/Concave path effect (Zoomed)\label{concave:BaselineConcaveEffectPath2}}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/BaselineConcaveEffectDist8060}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/BaselineConcaveEffectMag8060}
{Baseline/Concave effect magnitude (80/60)\label{concave:BaselineConcaveEffectMag8060}}
% \begin{figure}
% \begin{center}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/BaselineConcavePerimeter8060}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/Baseline8060End}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/Concave8060End}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/BaselineConcaveEffectPath80601}
...
%COVERBASELINE8060.py
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/BaselineConcaveEffectPath80602}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/Baseline4560End}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/Concave4560End}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/Concave4560-1}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/Concave4560-2}
...
%COVERBASELINE4560END3.py
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/Concave4560-3}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/ConcavePerimeter4560-DIST}
...
%SWARMHOLE-DIST-4560.py
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/ConcavePerimeter4560-DIST-2}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/ConcavePerimeter4560-MAG}
...
%SWARMHOLE-MAG-4560.py
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/ConcavePerimeter4560-MAG-2}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/ConcavePerimeter4560-1}
...
%COVERBASELINE4560.py
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/SwarmCoverage4560-1}
...
%COVERBASELINE4560.py
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/SwarmCoverage4560-2}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/OilSlick}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/OilSpillSimulator}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/OilSpillBase1}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/OilSpillBase2}
...
%% \end{figure}
%COVERBASELINE8060OILSPILL3.py
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/OilSpillBase3}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/OilSpillConcave1}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/OilSpillConcave2}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/OilSpillConcave3}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/OilSpillPerimeter8060-DIST-1}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/OilSpillPerimeter8060-MAG-1}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/OilSpillPerimeter8060-1}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/SWARMCOVER456060BASELINE}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt)[width=18cm]{figures/SWARMCOVER456060CONCAVE}
...
\bibliography{thesis}
\newpage
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{Images/eliot}}]{Neil Eliot}
