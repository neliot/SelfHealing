...
%\end{tikzpicture}
%	\includegraphics{figures/stableswarm}
%\end{figure}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt){figures/neighbours} {Neighbour agents\label{define:neighbours}}
...
\end{equation}
\fbox{is this an over estimate -- distances are counted twice}
